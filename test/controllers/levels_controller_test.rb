...
class LevelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create level" do
    assert_difference("Level.count") do
      post levels_url, params: { level: { level_depth: @level.level_depth, level_height: @level.level_height, section_id: @level.section_id } }
    end
  ...
  test "should update level" do
    patch level_url(@level), params: { level: { level_depth: @level.level_depth, level_height: @level.level_height, section_id: @level.section_id } }
